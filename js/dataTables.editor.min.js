...
j.multiGet(a),l=o(i),k=d.isArray(m)&&i.indexOf("[]")!==-1?o(i.replace(/\[.*$/,"")+"-many-count"):null;l(c,m);k&&k(c,m.length);if(g==="edit"&&(!s[i]||!E(m,s[i][a]))){l(e,m);f=true;k&&k(e,m.length)}}});d.isEmptyObject(c)||(m[a]=c);d.isEmptyObject(e)||(j[a]=e)}),"create"===g||"all"===t||"allIfChanged"===t&&f)q.data=m;else if("changed"===t&&f)q.data=j;else{this.s.action=null;if("close"===r.onComplete&&(e===k||e))this._close(!1);else if("function"===typeof r.onComplete)r.onComplete(this);a&&a.call(this);
this._processing(!1);this._event("submitComplete");return}else"remove"===g&&d.each(p,function(a,b){q.data[a]=b.data});this._legacyAjax("send",g,q);v=d.extend(!0,{},q);c&&c(q);!1===this._event("preSubmit",[q,g])?this._processing(!1):(this.s.ajax||this.s.ajaxUrl?this._ajax:this._submitTable).call(this,q,function(c,d){i._submitSuccess(c,d,q,v,g,n,e,a,b)},function(a,c,e){i._submitError(a,c,e,b,q)},q)};f.prototype._submitTable=function(a,b){var c=a.action,e={data:[]},i=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),
f=u.ext.oApi._fnSetObjectDataFn(this.s.idSrc);if("remove"!==c){var m=this._dataSource("fields",this.modifier());d.each(a.data,function(a,b){var g;g="edit"===c?d.extend(!0,{},m[a].data,b):d.extend(!0,{},b);"create"===c&&i(g)===k?f(g,+new Date+""+a):f(g,a);e.data.push(g)})}b(e)};f.prototype._submitSuccess=function(a,b,c,e,i,f,m,j,g){var l=this,n,q=this.s.fields,p=this.s.editOpts,c=this.s.modifier;a.error||(a.error="");a.fieldErrors||(a.fieldErrors=[]);if(b||a.error||a.fieldErrors.length)this.error(a.error),
d.each(a.fieldErrors,function(a,b){var c=q[b.name];c.error(b.status||"Error");if(a===0)if(p.onFieldError==="focus"){d(l.dom.bodyContent,l.s.wrapper).animate({scrollTop:d(c.node()).position().top},500);c.focus()}else if(typeof p.onFieldError==="function")p.onFieldError(l,b)}),g&&g.call(l,a);else{b={};if(a.data&&("create"===i||"edit"===i)){this._dataSource("prep",i,c,e,a,b);for(e=0;e<a.data.length;e++)n=a.data[e],this._event("setData",[a,n,i]),"create"===i?(this._event("preCreate",[a,n]),this._dataSource("create",
q,n,b),this._event(["create","postCreate"],[a,n])):"edit"===i&&(this._event("preEdit",[a,n]),this._dataSource("edit",c,q,n,b),this._event(["edit","postEdit"],[a,n]));this._dataSource("commit",i,c,a.data,b)}else"remove"===i&&(this._dataSource("prep",i,c,e,a,b),this._event("preRemove",[a]),this._dataSource("remove",c,q,b),this._event(["remove","postRemove"],[a]),this._dataSource("commit",i,c,a.data,b));if(f===this.s.editCount)if(this.s.action=null,"close"===p.onComplete&&(m===k||m))this._close(a.data?
!0:!1);else if("function"===typeof p.onComplete)p.onComplete(this);j&&j.call(l,a);this._event("submitSuccess",[a,n])}this._processing(!1);this._event("submitComplete",[a,n])};f.prototype._submitError=function(a,b,c,e,d){this.error(this.i18n.error.system);this._processing(!1);e&&e.call(this,a,b,c);this._event(["submitError","submitComplete"],[a,b,c,d])};f.prototype._tidy=function(a){var b=this,c=this.s.table?new d.fn.dataTable.Api(this.s.table):null,e=!1;c&&(e=c.settings()[0].oFeatures.bServerSide);
return this.s.processing?(this.one("submitComplete",function(){if(e)c.one("draw",a);else setTimeout(function(){a()},10)}),!0):"inline"===this.display()||"bubble"===this.display()?(this.one("close",function(){if(b.s.processing)b.one("submitComplete",function(b,d){if(e&&d)c.one("draw",a);else setTimeout(function(){a()},10)});else setTimeout(function(){a()},10)}).blur(),!0):!1};f.prototype._weakInArray=function(a,b){for(var c=0,e=b.length;c<e;c++)if(a==b[c])return c;return-1};f.defaults={table:null,
ajaxUrl:null,fields:[],display:"lightbox",ajax:null,idSrc:"DT_RowId",events:{},i18n:{create:{button:"New",title:"Create new entry",submit:"Create"},edit:{button:"Edit",title:"Edit entry",submit:"Update"},remove:{button:"Delete",title:"Delete",submit:"Delete",confirm:{_:"Are you sure you wish to delete %d rows?",1:"Are you sure you wish to delete 1 row?"}},error:{system:'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'},multi:{title:"Multiple values",
info:"The selected items contain different values for this input. To edit and set all items for this input to the same value, click or tap here, otherwise they will retain their individual values.",restore:"Undo changes",noMulti:"This input can be edited individually, but not part of a group."},datetime:{previous:"Previous",next:"Next",months:"January February March April May June July August September October November December".split(" "),weekdays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),amPm:["am",
"pm"],unknown:"-"}},formOptions:{bubble:d.extend({},f.models.formOptions,{title:!1,message:!1,buttons:"_basic",submit:"changed"}),inline:d.extend({},f.models.formOptions,{buttons:!1,submit:"changed"}),main:d.extend({},f.models.formOptions)},legacyAjax:!1};var O=function(a,b,c){d.each(b,function(b,d){var f=d.valFromData(c);if(f!==k){var m=G(a,d.dataSrc());m.filter("[data-editor-value]").length?m.attr("data-editor-value",f):m.each(function(){for(;this.childNodes.length;)this.removeChild(this.firstChild)}).html(f)}})},
G=function(a,b){var c="keyless"===a?q:d('[data-editor-id="'+a+'"]');return d('[data-editor-field="'+b+'"]',c)},H=f.dataSources={},I=function(a,b){return a.settings()[0].oFeatures.bServerSide&&"none"!==b.s.editOpts.drawType},P=function(a){a=d(a);setTimeout(function(){a.addClass("highlight");setTimeout(function(){a.addClass("noHighlight").removeClass("highlight");setTimeout(function(){a.removeClass("noHighlight")},550)},500)},20)},J=function(a,b,c,e,d){b.rows(c).indexes().each(function(c){var c=b.row(c),
m=c.data(),j=d(m);j===k&&f.error("Unable to find row identifier",14);a[j]={idSrc:j,data:m,node:c.node(),fields:e,type:"row"}})},K=function(a,b,c,e,i,h){b.cells(c).indexes().each(function(m){var j=b.cell(m),g=b.row(m.row).data(),g=i(g),l;if(!(l=h)){l=m.column;l=b.settings()[0].aoColumns[l];var n=l.editField!==k?l.editField:l.mData,p={};d.each(e,function(a,b){if(d.isArray(n))for(var c=0;c<n.length;c++){var e=b,f=n[c];e.name()===f&&(p[e.name()]=e)}else b.name()===n&&(p[b.name()]=b)});d.isEmptyObject(p)&&
f.error("Unable to automatically determine field from source. Please specify the field name.",11);l=p}var q="object"===typeof c&&c.nodeName||c instanceof d;J(a,b,m.row,e,i);a[g].attach=q?[d(c).get(0)]:[j.node()];a[g].displayFields=l})},Q=function(a){return"string"===typeof a?"#"+a.replace(/(:|\.|\[|\]|,)/g,"\\$1"):"#"+a};H.dataTable={individual:function(a,b){var c=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),e=d(this.s.table).DataTable(),f=this.s.fields,h={},m;b&&(d.isArray(b)||(b=[b]),m={},d.each(b,
function(a,b){m[b]=f[b]}));K(h,e,a,f,c,m);return h},fields:function(a){var b=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),c=d(this.s.table).DataTable(),e=this.s.fields,f={};d.isPlainObject(a)&&(a.rows!==k||a.columns!==k||a.cells!==k)?(a.rows!==k&&J(f,c,a.rows,e,b),a.columns!==k&&c.cells(null,a.columns).indexes().each(function(a){K(f,c,a,e,b)}),a.cells!==k&&K(f,c,a.cells,e,b)):J(f,c,a,e,b);return f},create:function(a,b){var c=d(this.s.table).DataTable();I(c,this)||(c=c.row.add(b),P(c.node()))},edit:function(a,
b,c,e){a=d(this.s.table).DataTable();if(!I(a,this)||"none"===this.s.editOpts.drawType){var f=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),h=f(c),m;try{m=a.row(Q(h))}catch(j){m=a}m.any()||(m=a.row(function(a,b){return h==f(b)}));m.any()?(m.data(c),c=d.inArray(h,e.rowIds),e.rowIds.splice(c,1)):m=a.row.add(c);P(m.node())}},remove:function(a,b,c){var b=d(this.s.table).DataTable(),e=c.cancelled;if(!I(b,this))if(0===e.length)b.rows(a).remove();else{var f=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),h=[];
b.rows(a).every(function(){var a=f(this.data());-1===d.inArray(a,e)&&h.push(this.index())});b.rows(h).remove()}},prep:function(a,b,c,e,f){if("edit"===a){var h=e.cancelled||[];f.rowIds=d.map(c.data,function(a,b){return!d.isEmptyObject(c.data[b])&&-1===d.inArray(b,h)?b:k})}else"remove"===a&&(f.cancelled=e.cancelled||[])},commit:function(a,b,c,e){b=d(this.s.table).DataTable();if("edit"===a&&e.rowIds.length)for(var f=e.rowIds,h=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc),m=0,e=f.length;m<e;m++)a=b.row(Q(f[m])),
a.any()||(a=b.row(function(a,b){return f[m]==h(b)})),a.any()&&a.remove();a=this.s.editOpts.drawType;"none"!==a&&b.draw(a)}};H.html={initField:function(a){var b=d('[data-editor-label="'+(a.data||a.name)+'"]');!a.label&&b.length&&(a.label=b.html())},individual:function(a,b){var c;if(a instanceof d||a.nodeName){c=a;b||(b=[d(a).attr("data-editor-field")]);var e=d.fn.addBack?"addBack":"andSelf",a=d(a).parents("[data-editor-id]")[e]().data("editor-id")}a||(a="keyless");b&&!d.isArray(b)&&(b=[b]);if(!b||
0===b.length)throw"Cannot automatically determine field name from data source";var e=H.html.fields.call(this,a),f=this.s.fields,h={};d.each(b,function(a,b){h[b]=f[b]});d.each(e,function(e,j){j.type="cell";var g;if(c)g=d(c);else{g=a;for(var l=b,k=d(),n=0,p=l.length;n<p;n++)k=k.add(G(g,l[n]));g=k.toArray()}j.attach=g;j.fields=f;j.displayFields=h});return e},fields:function(a){var b={},c={},e=this.s.fields;a||(a="keyless");d.each(e,function(b,e){var d;d=e.dataSrc();d=G(a,d);d=d.filter("[data-editor-value]").length?
d.attr("data-editor-value"):d.html();e.valToData(c,null===d?k:d)});b[a]={idSrc:a,data:c,node:q,fields:e,type:"row"};return b},create:function(a,b){if(b){var c=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(b);d('[data-editor-id="'+c+'"]').length&&O(c,a,b)}},edit:function(a,b,c){a=u.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(c)||"keyless";O(a,b,c)},remove:function(a){d('[data-editor-id="'+a+'"]').remove()}};f.classes={wrapper:"DTE",processing:{indicator:"DTE_Processing_Indicator",active:"processing"},
header:{wrapper:"DTE_Header",content:"DTE_Header_Content"},body:{wrapper:"DTE_Body",content:"DTE_Body_Content"},footer:{wrapper:"DTE_Footer",content:"DTE_Footer_Content"},form:{wrapper:"DTE_Form",content:"DTE_Form_Content",tag:"",info:"DTE_Form_Info",error:"DTE_Form_Error",buttons:"DTE_Form_Buttons",button:"btn"},field:{wrapper:"DTE_Field",typePrefix:"DTE_Field_Type_",namePrefix:"DTE_Field_Name_",label:"DTE_Label",input:"DTE_Field_Input",inputControl:"DTE_Field_InputControl",error:"DTE_Field_StateError",
...
e=this._daysInMonth(a,b),f=(new Date(Date.UTC(a,b,1))).getUTCDay(),h=[],g=[];if(this.c.firstDay>0){f=f-this.c.firstDay;f<0&&(f=f+7)}for(var j=e+f,k=j;k>7;)k=k-7;var j=j+(7-k),k=this.c.minDate,l=this.c.maxDate;if(k){k.setUTCHours(0);k.setUTCMinutes(0);k.setSeconds(0)}if(l){l.setUTCHours(23);l.setUTCMinutes(59);l.setSeconds(59)}for(var n=0,p=0;n<j;n++){var q=new Date(Date.UTC(a,b,1+(n-f))),r=this.s.d?this._compareDates(q,this.s.d):false,s=this._compareDates(q,c),t=n<f||n>=e+f,u=k&&q<k||l&&q>l,v=this.c.disableDays;
d.isArray(v)&&d.inArray(q.getUTCDay(),v)!==-1?u=true:typeof v==="function"&&v(q)===true&&(u=true);g.push(this._htmlDay({day:1+(n-f),month:b,year:a,selected:r,today:s,disabled:u,empty:t}));if(++p===7){this.c.showWeekNumber&&g.unshift(this._htmlWeekOfYear(n-f,b,a));h.push("<tr>"+g.join("")+"</tr>");g=[];p=0}}c=this.c.classPrefix+"-table";this.c.showWeekNumber&&(c=c+" weekNumber");return'<table class="'+c+'"><thead>'+this._htmlMonthHead()+"</thead><tbody>"+h.join("")+"</tbody></table>"},_htmlMonthHead:function(){var a=
...
this.s.d,b=a?a.getUTCHours():0;if(this.s.parts.hours12){this._optionSet("hours",this._hours24To12(b));this._optionSet("ampm",b<12?"am":"pm")}else this._optionSet("hours",b);this._optionSet("minutes",a?a.getUTCMinutes():0);this._optionSet("seconds",a?a.getSeconds():0)},_show:function(){var a=this,b=this.s.namespace;this._position();d(s).on("scroll."+b+" resize."+b,function(){a._position()});d("div.DTE_Body_Content").on("scroll."+b,function(){a._position()});d(q).on("keydown."+b,function(b){(b.keyCode===
9||b.keyCode===27||b.keyCode===13)&&a._hide()});setTimeout(function(){d("body").on("click."+b,function(b){!d(b.target).parents().filter(a.dom.container).length&&b.target!==a.dom.input[0]&&a._hide()})},10)},_writeOutput:function(a){var b=this.s.d,b=s.moment?s.moment.utc(b,k,this.c.momentLocale,this.c.momentStrict).format(this.c.format):b.getUTCFullYear()+"-"+this._pad(b.getUTCMonth()+1)+"-"+this._pad(b.getUTCDate());this.dom.input.val(b);a&&this.dom.input.focus()}});f.DateTime._instance=0;f.DateTime.defaults=
{classPrefix:"editor-datetime",disableDays:null,firstDay:1,format:"YYYY-MM-DD",i18n:f.defaults.i18n.datetime,maxDate:null,minDate:null,minutesIncrement:1,momentStrict:!0,momentLocale:"en",onChange:function(){},secondsIncrement:1,showWeekNumber:!1,yearRange:10};var L=function(a,b){if(b===null||b===k)b=a.uploadText||"Choose file...";a._input.find("div.upload button").html(b)},R=function(a,b,c){var e=a.classes.form.button,i=d('<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload"><button class="'+
e+'" /><input type="file"/></div><div class="cell clearValue"><button class="'+e+'" /></div></div><div class="row second"><div class="cell"><div class="drop"><span/></div></div><div class="cell"><div class="rendered"/></div></div></div></div>');b._input=i;b._enabled=true;L(b);if(s.FileReader&&b.dragDrop!==false){i.find("div.drop span").text(b.dragDropText||"Drag and drop a file here to upload");var h=i.find("div.drop");h.on("drop",function(d){if(b._enabled){f.upload(a,b,d.originalEvent.dataTransfer.files,
L,c);h.removeClass("over")}return false}).on("dragleave dragexit",function(){b._enabled&&h.removeClass("over");return false}).on("dragover",function(){b._enabled&&h.addClass("over");return false});a.on("open",function(){d("body").on("dragover.DTE_Upload drop.DTE_Upload",function(){return false})}).on("close",function(){d("body").off("dragover.DTE_Upload drop.DTE_Upload")})}else{i.addClass("noDrop");i.append(i.find("div.rendered"))}i.find("div.clearValue button").on("click",function(){f.fieldTypes.upload.set.call(a,
b,"")});i.find("input[type=file]").on("change",function(){f.upload(a,b,this.files,L,function(b){c.call(a,b);i.find("input[type=file]").val("")})});return i},A=function(a){setTimeout(function(){a.trigger("change",{editor:true,editorSet:true})},0)},v=f.fieldTypes,r=d.extend(!0,{},f.models.fieldType,{get:function(a){return a._input.val()},set:function(a,b){a._input.val(b);A(a._input)},enable:function(a){a._input.prop("disabled",false)},disable:function(a){a._input.prop("disabled",true)},canReturnSubmit:function(){return true}});
...
[a._val])},enable:function(a){a._input.find("input").prop("disabled",false);a._enabled=true},disable:function(a){a._input.find("input").prop("disabled",true);a._enabled=false},canReturnSubmit:function(){return false}});u.ext.editorFields&&d.extend(f.fieldTypes,u.ext.editorFields);u.ext.editorFields=f.fieldTypes;f.files={};f.prototype.CLASS="Editor";f.version="1.6.3";return f});
